...
# Funzione per interrogare LLAMA
...
def main():
    """
    Funzione principale che gestisce il ciclo di input e output del bot.
    """
    dataset = load_dataset()
    print("Chatbot di emergenza - Digita la tua domanda:")
    print("Scrivi 'esci' per terminare.\n")
    
    while True:
        user_query = input("Tu: ").strip()
        if user_query.lower() in ["esci", "quit", "exit"]:
            print("Chiusura del chatbot. Arrivederci!")
            break
